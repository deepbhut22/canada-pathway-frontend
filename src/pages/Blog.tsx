    ...
    //                         <h1 className="text-2xl md:text-4xl font-bold mb-4 text-white">Immigration Blogs</h1>
    //                         <p className="text-sm md:text-lg text-gray-300 max-w-3xl">
    //                             Stay informed with the latest immigration news, policy updates, and helpful guides. Our blog provides accurate, easy-to-understand information to support your immigration journey.
    //                         </p>
    //                     </div>
    //                 {/* </div> */}
    ...
    //                     {posts.length > 0 ? (
    //                         <>
    //                             <p className="text-gray-600 mb-6">Showing {posts.length} results</p>
...
const blogPosts = blogPostData as BlogPost[];
...
Stay informed with the latest immigration news, policy updates, and helpful guides. Our blog provides accurate, easy-to-understand information to support your immigration journey.                    </p>
                </div>

                <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-14 my-8">
                    {blogPosts.map((post) => (
                        <Card key={post.slug} className='bg-gray-100 shadow-xl border-2 border-secondary-200' interactive>
                            <CardHeader>
